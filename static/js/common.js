...
function makeHeader(blog_username, username){
    ...
    header_body += '<h1 class="logo"><a href=""> ' + decodeURI(blog_username) + '的空间</a></h1>';
    header_body += '<li><a href=' + index_url + '>网站首页</a></li>';
    header_body += '<li>';
    ...
    if (username){
        ...
        // 我写的a标签跳转
        // header_body += '<a href="" id="login_out" target="_blank">登出</a>';
